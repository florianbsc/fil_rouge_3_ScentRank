...
if (db.perfumes.countDocuments() === 1) {
    db.perfumes.insertMany([
        {
            name: "J'Adore",
            brand: "Dior",
            description: "Un bouquet floral lumineux",
            genre: "female",
            imageUrl: "https://example.com/jadore.jpg",
            olfactoryNotes: {
                top: ["Poire","Melon","Magnolia","Pêche","Mandarine","Bergamote"],
                heart: ["Jasmin","Muguet","Tubéreuse","Freesia", "Rose", "Orchidée", "Violette", "Prune"],
                base: ["Musc", "Vanille","Cèdre","Prune"],
            },
            price: NumberDecimal("123.75"),
            imageURL: "https://example.com/jadore.jpg",
